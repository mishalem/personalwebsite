...
def create_app(debug=False):
	...
	db.createUser(email='admin@email.com' ,password='password', role='admin', balance=100)
	db.createUser(email='misha@email.com' ,password='password', role='admin', balance=100)
